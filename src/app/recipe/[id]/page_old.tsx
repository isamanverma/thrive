        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <div className="relative hidden sm:block">
              ...
              <input
                className="block w-full rounded-md border-border bg-muted pl-10 pr-3 py-2 text-sm text-foreground focus:border-orange-500 focus:ring-orange-500"
                placeholder="Search"
                type="text"
              />
            </div>
            <button className="rounded-full p-2 text-muted-foreground hover:bg-orange-100 hover:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
              <svg
                className="h-6 w-6"
                fill="none"
                stroke="currentColor"
              ...
              <div className="mt-8 rounded-xl border border-border bg-card p-6 shadow-lg">
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-lg bg-orange-500 px-5 py-3 text-base font-semibold text-white shadow-sm transition-colors hover:bg-orange-700 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-orange-500"
                  >
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-lg border border-orange-500 bg-green-50 px-5 py-3 text-base font-semibold text-orange-500 shadow-sm transition-colors hover:bg-orange-100 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-orange-500"
                  >
                  ...
                  <div className="text-center py-8">
                    ...
                    {recipe.sourceUrl && (
                      <Link
                        ...
                        target="_blank"
                        className="text-orange-500 hover:text-orange-700 underline mt-2 inline-block"
                      >
