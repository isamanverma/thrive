      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-24 h-12 text-base border-2 focus:border-orange-500 transition-colors"
          />
          <Button
            onClick={handleSearch}
            disabled={loading}
            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 hover:bg-orange-700"
            size="sm"
          >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                {recipe.diets?.slice(0, 2).map((diet) => (
                  <span
                    key={diet}
                    className="px-2.5 py-1 bg-green-50 text-orange-700 dark:bg-green-950 dark:text-green-300 rounded-full text-xs font-medium"
                  >
                    {diet}
                  </span>
                ))}
              ...
              <div className="flex justify-between items-center pt-2">
                <div className="flex gap-2">
                  <Button
                    ...
                    className="hover:bg-orange-50 hover:border-green-200 hover:text-orange-700 transition-colors"
                  >
                    Quick View
                  </Button>
                  <Button
                ...
                <div className="flex gap-1">
                  ...
                  <Button
                    ...
                    className="p-2 hover:bg-orange-50 hover:text-orange-500 transition-colors"
                  >
